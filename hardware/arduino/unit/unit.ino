...
// ⚠️ 注意：由於手機熱點 (Personal Hotspot) 預設通常會過濾並阻擋 255.255.255.255 廣播封包，
// 請在此填寫執行 Python 接收端電腦的確切實體 IP。
// 💡 電腦 IP 可以直接在電腦端執行 `python python_scripts/mr60_logger.py` 啟動時自動獲取。
const char* udpAddress = "192.168.43.100";  
